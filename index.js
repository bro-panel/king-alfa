...
╰───────────❍
╭───❍「 *🌐BOT WEB PAGE* 」
┃ https://shageemdpairwebsitenow.onrender.com/
╰───────────❍
╭───❍「 *🫳JOIN CHANNEL* 」
...
╰───────────❍
╭───❍「 *📍BOT PREFIX* 」
┃ _Configure Your Prefix_ .
╰───────────❍
╭───❍「 *⚙️AUTOMATION BY* 」
┃ *𝐒ʜᴀɢᴇᴇ 𝐌ᴅ💸*
╰───────────❍`;
    conn.sendMessage(conn.user.id, { image: { url: `https://i.ibb.co/sdsy6LG6/3mfp-OTP7c1.jpg` }, caption: up })
  }
  })
  ...
  const udp = botNumber.split('@')[0];
    const jawadop = ['94762048412', '94740433291', '94703403671'];
...
END:VCARD`,
  ...
  app.get("/", (req, res) => {
  res.send("KING 𝐒ʜᴀɢᴇᴇ 𝐌ᴅ V-2 STARTED NOW SAFELY ✅");
  });
