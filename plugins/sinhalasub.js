...
cmd({
  ...
  try {
    ...
    let filmList = `□ *𝐒ʜᴀɢᴇᴇ 𝐌ᴅ CINEMATIC VAULT* □\n\n`;
    ...
    filmList += `${frozenTheme.resultEmojis[9]} > *ＳＨAG EＥ 🌑⚡ | ⛚ Sʜᴀɢᴇᴇ   BᴏᴛＺｚ ᴢ  ᴛᴇᴄʜ*`;
    ...
    const selectionHandler = async (update) => {
      ...
      if (repliedToId === movieListMessageKey.id) {
        ...
        downloadOptions += `${frozenTheme.resultEmojis[9]} > *© ᴘᴏᴡᴇʀᴇᴅ ʙʏ 𝐒ʜᴀɢᴇᴇ 𝐌ᴅ*`;
